    ...
    >
      ...
      <Link
        ...
        style={{
          ...
          gap: 8,
          textDecoration: "none",
          zIndex: 102, /* Stays visible above mobile menu overlay */
        }}
      >
        <span
          style={{
      ...
      {isMobile && menuOpen && (
        <div
          style={{
            ...
            display: "flex",
            flexDirection: "column",
            padding: "88px 24px 40px 24px", /* Extra padding top to keep menu links clear of header logo area */
        ...
        >
          ...
          {/* Action Footer Wrapper (Pushed down to the bottom) */}
