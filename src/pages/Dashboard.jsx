...
function StatCard({ icon, label, value, trend, color = 'var(--teal)' }) {
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: 'var(--ink)', letterSpacing: '-1px', lineHeight: 1,
      }}>{value}</div>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <h1 style={{
              ...
              color: 'var(--ink)', letterSpacing: '-0.4px',
            }}>Dashboard</h1>
          </div>
        ...
        <div style={{ padding: '32px', flex: 1 }}>
          ...
          {loading ? (
            ...
            <div style={{ display: 'flex', gap: 20, marginBottom: 32, flexWrap: 'wrap' }}>
              ...
              <StatCard icon="📈" label="Completion rate" value={stats ? `${stats.completion_rate}%` : '—'} trend="+3.1%" color="var(--amber)" />
            </div>
          )}
                    ...
                    filtered.map((s, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td style={{ padding: '16px 24px', fontSize: 14, color: 'var(--ink-soft)' }}>
                            {s.responses.toLocaleString()}
                          </td>
                          <td style={{ padding: '16px 24px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                              <MiniBar pct={s.completion}
                                color={s.status === 'active' ? 'var(--teal)' : s.status === 'closed' ? 'var(--muted)' : 'var(--amber)'}
                              />
                              <span style={{ fontSize: 13, color: 'var(--muted)', minWidth: 36 }}>
                                {s.completion}%
                              </span>
                            </div>
                          </td>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 14, color: 'var(--ink)', fontWeight: 400 }}>{a.text}</div>
