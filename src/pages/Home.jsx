  ...
  return (
    <>
      <style>{`
        ...
        .sp-h1 { font-family: 'Sora', sans-serif; font-size: clamp(40px, 7vw, 78px); font-weight: 700; line-height: 1.07; color: #FAFAF8; letter-spacing: -2.5px; margin-bottom: 28px; max-width: 800px; }
        ...
        .sp-hero-sub { font-size: 18px; color: rgba(250,250,248,0.55); max-width: 520px; margin: 0 auto 48px; line-height: 1.8; font-weight: 300; letter-spacing: 0.01em; }
        ...
        .sp-stats { display: flex; gap: 56px; margin-top: 80px; flex-wrap: wrap; justify-content: center; }
        .sp-stat-val { font-family: 'Sora', sans-serif; font-size: 36px; font-weight: 700; color: #FAFAF8; letter-spacing: -1.5px; line-height: 1; }
        .sp-stat-label { font-size: 13px; color: rgba(250,250,248,0.4); margin-top: 5px; font-weight: 400; letter-spacing: 0.02em; }

        .sp-section { padding: 100px 24px; }
        ...
        .sp-h2 { font-family: 'Sora', sans-serif; font-size: clamp(28px, 4vw, 44px); font-weight: 700; letter-spacing: -1.2px; color: #1a1a1a; line-height: 1.2; max-width: 640px; margin: 0 auto; }
        .sp-h2-light { color: #FAFAF8; }
        .sp-section-desc { font-size: 17px; color: #6b7280; margin-top: 16px; line-height: 1.75; font-weight: 300; max-width: 500px; margin-left: auto; margin-right: auto; }

        .sp-grid-3 { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px; max-width: 1080px; margin: 56px auto 0; }
        .sp-card { background: #fff; border-radius: 16px; padding: 32px 28px; border: 1px solid #E8E7E2; transition: transform 0.2s, box-shadow 0.2s; }
        ...
        .sp-stats-row { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1px; background: rgba(250,250,248,0.08); border: 1px solid rgba(250,250,248,0.08); border-radius: 16px; overflow: hidden; max-width: 880px; margin: 56px auto 0; }
        .sp-stat-cell { padding: 36px 28px; background: rgba(250,250,248,0.03); text-align: center; }
        .sp-stat-cell-val { font-family: 'Sora', sans-serif; font-size: 38px; font-weight: 700; color: #FAFAF8; letter-spacing: -2px; line-height: 1; }
        .sp-stat-cell-label { font-size: 13px; color: rgba(250,250,248,0.4); margin-top: 6px; font-weight: 400; }

        /* ── TEAM CARDS ── */
        .sp-team-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 10px; max-width: 1080px; margin: 56px auto 0; }
        ...
        .sp-team-img-wrap { position: relative; width: 100%; height: 320px; overflow: hidden; }
.sp-team-img-wrap img { width: 100%; height: 100%; object-fit: cover; object-position: top 5%; display: block; transition: transform 0.4s ease; }
        ...
        .sp-team-body { padding: 22px 24px 24px; }
        ...
        .sp-cta { padding: 100px 24px; background: linear-gradient(160deg, #0E1117 0%, #0a2e2a 100%); text-align: center; }
        ...
        .sp-footer { padding: 28px 40px; background: #0a0d11; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; }
      ...
      <div className="sp-root">
        ...
        <section className="sp-section sp-section-tinted">
          <div style={{ textAlign: 'center' }}>
            ...
            <p className="sp-section-desc">
              One platform to build surveys, collect responses, and turn raw data into decisions.
            </p>
          </div>
        ...
        <section className="sp-section sp-section-dark" style={{ padding: '80px 24px' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <h2 className="sp-h2 sp-h2-light" style={{ color: '#FAFAF8', maxWidth: 500 }}>
              Trusted at scale across the region
            </h2>
          </div>
        ...
        <section className="sp-section sp-section-light">
          <div style={{ textAlign: 'center' }}>
            ...
            <div className="sp-divider" />
            <p className="sp-section-desc">
              Meet the people driving SurveyPulse forward across the GCC.
            </p>
          </div>
        ...
        <section className="sp-cta">
          ...
          <h2 className="sp-h2 sp-h2-light" style={{ color: '#FAFAF8' }}>
